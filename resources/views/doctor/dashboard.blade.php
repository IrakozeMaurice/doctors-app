        ...
        <div class="col-md-4 display-none">
            <div class="card" style="min-height: 100%">
                ...
                <div class="card-body p-0">
                    <ul class="list-group">
                        <a class="list-group-item list-group-item-action bg-success text-white" href="#">Dashboard</a>
                    ...
                    <div class="row mt-3">
                        <div class="col-4">
                            <a href="#" class="custom-link">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <img class="img-custom" src="{{ asset('images/doctor1.jpg') }}" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" class="custom-link">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <img class="img-custom" src="{{ asset('images/doctor2.jpg') }}" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" class="custom-link">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <img class="img-custom" src="{{ asset('images/doctor3.jpg') }}" alt="">
